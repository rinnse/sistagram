...
public class Paging implements Serializable
{
	...
	private int startNum;      // 시작 번호 (게시물 번호 적용 DESC)
	 ...
	 */
	public Paging(String url, int totalCount, int listCount, int pageCount, int curPage, String pageTagName)
	{
	 ...
	 * @param pageTagName
	 */
	public Paging(String url, String formName, int totalCount, int listCount, int pageCount, int curPage, String pageTagName)
	{
		this.url = url;
	...
	// curPage가 필요없어서 생성함
	public Paging(String url, int totalCount, int listCount) {
		this.url = url;
		this.totalCount = totalCount;
		this.listCount = listCount;
	}
