		   ...
		   $.ajax({
			   ...
			   success:function(response){
				  if(response.code == 0){
			         ...
			         location.href = "/main";  //인스타그램 메인 화면
...
<body>
    <div class="main">
        <div class="container">
            <div class="logo">
                <a href="/index.jsp"><img src="/resources/images/Sistagram.png" alt="Sistagram" class="brand_logo"></a>
            </div>
            <div class="centent">
                <form name="login_form" action="/main" method="POST">
