...
<div>
   <div>
      <div class="main">  <!-- 검색했을 때와 게시물을 작성한 사용자의 프로필을 보고 싶을 때의 화면 구성 -->
         <div class="aaa">
            <div>
              <div>
                 ...
                 <div class="profile" style="width:100%">
                  <div class="profile-container">
                    ...
                    <section class="profile-info">
                 		<p style="font-style: thin; margin-top:-17px; margin-bottom:2px;">${user.userId}</p>
             ...
             <c:if test="${!empty list}"> 
              <div style="width: 175%;">              	              
                 <c:forEach var="board" items="${list}" varStatus="loop">
                       <a href="/board/view?boardNum=${board.boardNum}"> <!-- 게시물 첨부파일 눌렀을 때, 게시물 상세 페이지로 이동 -->
			        ...
			        <!--loop.index : 0부터 시작해서 반복 횟수를 제공하는 속성으로,
			        			인텍스를 3으로 나눈 나머지가 2인 경우, 줄바꿈 처리  -->
                 </c:forEach>
              </div> 
             </c:if>  	
